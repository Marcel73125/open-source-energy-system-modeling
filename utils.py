...
def printglucoselevel(g_init, time_hours): #g_init = initial glucose level in mg/dl;  #time_hours in hours
    if g_init >= 0: #checks if value for g_init is valid
        ...
        if time_hours >= 0:
            ...
            result_value_2 = sol_2.subs({k: k_value, t: time_hours}) # .subs substitutes the symbols k with the defined k_value and t with handed over time value in hours
